          ...
          <form onSubmit={handleIngest} className="flex space-x-4">
            <div className="flex-1">
              <input 
                ...
                placeholder="Enter local absolute path (e.g., C:/projects/my-app)"
            ...
            <button 
              ...
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium px-6 rounded-xl transition-all shadow-sm hover:shadow disabled:opacity-50"
            >
